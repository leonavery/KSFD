...
mkdir -p $images
rm $images/*frame*.png
gtime -v gnice -n 19 $python $moviemaker -v -n 1501 -e 10000 --vmax=$vmax --names=$ssnames -p $prefix "$iname"a
gtime -v gnice -n 19 $python $moviemaker -v -n 1501 -s 10000 -e 200000 --vmax=$vmax --names=$ssnames -p $prefix "$iname"b
